...
var MatchSchema = yup__WEBPACK_IMPORTED_MODULE_2__["object"]().shape({
  ...
  owner: yup__WEBPACK_IMPORTED_MODULE_2__["string"]().email("Must provide a valid email").required("Required") // date: Yup.date()
  //   .min(new Date()) // Today?
...
var Input = function Input(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    ...
    id: field.name,
    className: "input"
  }, props)), touched[field.name] && errors[field.name] && react__WEBPACK_IMPORTED_MODULE_0__["default"].createElement("div", {
    className: "error"
  }, errors[field.name])));
};
/**
...
//# sourceMappingURL=index.js.3e7934c2a54d1cb40555.hot-update.js.map